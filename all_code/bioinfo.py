...
'''This module is a collection of useful bioinformatics functions written during the Bioinformatics and Genomics Program coursework 2023.'''

__version__ = "0.5.2"         # Read way more about versioning here:
